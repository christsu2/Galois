...
//
//      Instance Name:  sram512x8
//      Words:          512
//      Word Width:     8
//      Pipeline:       No
//
//      Creation Date:  2001-04-05 17:40:47Z
//      Version: 	2000Q3V1
//
...
module sram512x8 (
   ...
   specify
      //etuphold(posedge CLK, CEN, 1.000, 0.500, NOT_CEN);
      //etuphold(posedge CLK &&& re_flag, WEN, 1.000, 0.500, NOT_WEN);
      //etuphold(posedge CLK &&& re_flag, A[0], 1.000, 0.500, NOT_A0);
      //etuphold(posedge CLK &&& re_flag, A[1], 1.000, 0.500, NOT_A1);
      //etuphold(posedge CLK &&& re_flag, A[2], 1.000, 0.500, NOT_A2);
      //etuphold(posedge CLK &&& re_flag, A[3], 1.000, 0.500, NOT_A3);
      //etuphold(posedge CLK &&& re_flag, A[4], 1.000, 0.500, NOT_A4);
      //etuphold(posedge CLK &&& re_flag, A[5], 1.000, 0.500, NOT_A5);
      //etuphold(posedge CLK &&& re_flag, A[6], 1.000, 0.500, NOT_A6);
      //etuphold(posedge CLK &&& re_flag, A[7], 1.000, 0.500, NOT_A7);
      //etuphold(posedge CLK &&& re_flag, A[8], 1.000, 0.500, NOT_A8);

      //etuphold(posedge CLK &&& re_data_flag, D[0], 1.000, 0.500, NOT_D0);
      //etuphold(posedge CLK &&& re_data_flag, D[1], 1.000, 0.500, NOT_D1);
      //etuphold(posedge CLK &&& re_data_flag, D[2], 1.000, 0.500, NOT_D2);
      //etuphold(posedge CLK &&& re_data_flag, D[3], 1.000, 0.500, NOT_D3);
      //etuphold(posedge CLK &&& re_data_flag, D[4], 1.000, 0.500, NOT_D4);
      //etuphold(posedge CLK &&& re_data_flag, D[5], 1.000, 0.500, NOT_D5);
      //etuphold(posedge CLK &&& re_data_flag, D[6], 1.000, 0.500, NOT_D6);
      //etuphold(posedge CLK &&& re_data_flag, D[7], 1.000, 0.500, NOT_D7);

      //eriod(posedge CLK, 3.000, NOT_CLK_PER);
      //idth(posedge CLK, 1.000, 0, NOT_CLK_MINH);
      //idth(negedge CLK, 1.000, 0, NOT_CLK_MINL);
